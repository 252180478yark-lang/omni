...
METRIC_REGISTRY: dict[str, dict] = {
    ...
    # is_jd 已隔离平台，故可复用「裸」别名（成交金额/访客数/浏览量…）；京东问句才会进这组。
    # 口径与商智概况 DOM 中文名对齐：cnt=访客数(UV)、qtty=浏览量(PV)；dis_qtty=曝光人数、qtty=曝光次数。
    "jd_gmv": {"cn": "京东成交金额", "unit": "元", "direction": "up_good",
               "aliases": ["成交金额", "成交额", "成交", "gmv", "销售额", "卖了多少"]},
    "jd_order_cnt": {"cn": "京东成交单量", "unit": "单", "direction": "up_good",
                     "aliases": ["成交单量", "成交订单数", "订单数", "订单", "单量", "出单"]},
    "jd_buyer_cnt": {"cn": "京东成交客户数", "unit": "人", "direction": "up_good",
                     "aliases": ["成交客户数", "成交用户数", "买家数", "成交人数", "客户数", "买家"]},
    "jd_sku_qtty": {"cn": "京东成交商品件数", "unit": "件", "direction": "up_good",
                    "aliases": ["成交商品件数", "成交件数", "件数", "销量"]},
    "jd_per_customer_price": {"cn": "京东客单价", "unit": "元", "direction": "up_good",
                              "aliases": ["客单价", "人均成交", "人均支付"]},
    "jd_item_uv": {"cn": "京东商品访客数", "unit": "人", "direction": "up_good",
                   "aliases": ["商品访客数", "商品访客", "商品uv"]},
    "jd_shop_uv": {"cn": "京东店铺访客数", "unit": "人", "direction": "up_good",
                   "aliases": ["店铺访客数", "访客数", "店铺访客", "店铺uv"]},
    "jd_exposure_uv": {"cn": "京东曝光人数", "unit": "人", "direction": "up_good",
                       "aliases": ["曝光人数", "曝光uv"]},
    "jd_item_pv": {"cn": "京东商品浏览量", "unit": "次", "direction": "up_good",
                   "aliases": ["商品浏览量", "商品浏览", "商品pv"]},
    "jd_shop_pv": {"cn": "京东店铺浏览量", "unit": "次", "direction": "up_good",
                   "aliases": ["店铺浏览量", "店铺浏览", "店铺pv"]},
    "jd_exposure_pv": {"cn": "京东曝光次数", "unit": "次", "direction": "up_good",
                       "aliases": ["曝光次数", "曝光量", "曝光", "曝光pv", "展现"]},
    "jd_uv_value": {"cn": "京东UV价值", "unit": "元", "direction": "up_good",
                    "aliases": ["uv价值", "访客价值", "uv 价值"]},
    "jd_add_cart_user": {"cn": "京东加购人数", "unit": "人", "direction": "up_good",
                         "aliases": ["加购人数", "加购客户", "加购人"]},
    "jd_add_cart_amt": {"cn": "京东加购金额", "unit": "元", "direction": "up_good",
                        "aliases": ["加购金额", "加购额"]},
    "jd_add_cart_rate": {"cn": "京东加购率", "unit": "比率", "direction": "up_good",
                         "aliases": ["加购率"]},
    "jd_item_pv_per_uv": {"cn": "京东商详人均浏览", "unit": "次", "direction": "up_good",
                          "aliases": ["人均浏览", "人均浏览次数", "商详人均浏览"]},
    "jd_item_stay_sec": {"cn": "京东商详平均停留", "unit": "秒", "direction": "up_good",
                         "aliases": ["商详停留", "商品停留时长", "详情页停留"]},
    "jd_shop_stay_sec": {"cn": "京东店铺平均停留", "unit": "秒", "direction": "up_good",
                         "aliases": ["店铺停留", "停留时长", "平均停留"]},
